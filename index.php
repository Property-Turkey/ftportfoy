...
<head>
    ...
    <meta property="og:image" content="https://ftportfoy.com/img/site_image.jpg" />
...
<body>
    ...
    <script>
        ...
        $(document).ready(function() {
            if($(window).width() > 576 && 'our-funds,contact-us,frequently-asked-questions,news,home'.indexOf( '<?=$currPage?>' ) > -1){ 
